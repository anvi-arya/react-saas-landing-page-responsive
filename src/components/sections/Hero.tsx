        ...
        <section className="relative pt-32 lg:pt-36">
            <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
                    <img src="https://media.istockphoto.com/id/618761378/photo/man-using-virtual-reality-simulator-headset.jpg?s=2048x2048&w=is&k=20&c=XBJWIC_QbpUILCSBSAA8yJ6LGnAhDSWtFtwn3wLn_ZU=" 
                         alt="Hero image"
                         width={2350}
                         height={2359}
